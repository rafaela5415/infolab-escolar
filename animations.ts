...
declare global {
  interface Window {
    InfoLabAnimations: InfoLabAnimations;
  }
}
...
function initAuthBackground(canvasId: string): void {
...
function reveal(selector: string, delayStep = 55): void {
...
function pulseElement(element: Element | null, className = "status-updated"): void {
